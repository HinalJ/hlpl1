...
// Adding remainder operation '%'. For floating-pointer mod we have fmod() which is in <cmath.h>.
// Which is included in our standard header file :).
// So we just add '%' in our Term() as above. And we have to add '%' in get() as well.
